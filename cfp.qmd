...
::: {.callout-tip}
Stay tuned and keep an eye on our [News section](index.qmd#news) for the latest updates.
:::

The open challenge aims to explore the *DiversityOne* dataset, one
of the largest and most geographically diverse smartphone datasets
about everyday life behavior. The dataset combines questionnaires
about demographic and psychosocial variables from 18K participants, and passive smartphone sensor data and self-reported annotation from 782 students across eight universities in eight countries.

This dataset is a rich and valuable research resource that can
be used to address research questions in multiple fields: machine
learning, mobile sensing, computational social science, design with
data, and many others. The open challenge offers the opportunity
to work on the dataset and gain useful feedback on your research.

We welcome contributions from researchers from *diverse backgrounds and geographical provenances*. In particular, we welcome
contributions that address aspects including, but not limited to:
...
-   **From now**: Submit your short research proposal using the [web form]({{< var link.request >}}) and
...
-   **July 13, 2026**: Abstract deadline. Submission platform: <https://new.precisionconference.com/submissions>. Go to the _Submissions_ tab, select DiversityOne Track in the boxes at the top (Society: _SIGCHI_  >  Conference: _Ubicomp/ISWC Workshop 2026_  >  Track: _Ubicomp/ISWC Workshop 2026 DiversityOne Challenge_), and click _Go_.

-   **July 15, 2026 23:59 AoE (Anywhere on Earth)**: Submission deadline

-   **~~July 27, 2026~~ July 30, 2026**: Author notification

-   **~~July 31, 2026~~**: Deadline for the camera-ready version of workshop papers to be included in the ACM DL
...
[**Documentation**](https://datascientiafoundation.github.io/docs/LivePeople/papers/diversityone.html) provides information about how to navigate the catalog, tools and available code to process the dataset, and description of the sensors.

[**Dataset webpage**](https://datascientia.eu/projects/diversityone/) summarizes the key information about the data.

[**Conference webpage UbiComp / ISWC 2026**]({{< var link.conference >}})
...
The paper should be prepared following the 2-column template following the [IMWUT instructions](https://dl.acm.org/journal/imwut/author-guidelines).
...
as part of the UbiComp 2026 proceedings. At least one author of each
...
The most promising papers will be invited to submit an extended version [IEEE Pervasive Computing](https://ieeexplore.ieee.org/xpl/RecentIssue.jsp?punumber=7756).
...
2.  **Proposal submission.** All authors must submit a data download
    request through the [web form]({{< var link.request >}}) by providing the following information:

    -   Names and contact information of the authors working on the
        dataset and their institution.
    -   Short description of the research proposal. Provide a short description of
        your idea and how you plan to use the dataset. _Please specify that request is related to this challenge_.
...
3.  **Dataset download.** The proposal request is evaluated by the
...
(See also the [submissions](https://datascientiafoundation.github.io/diversityone-2025/papers.html) of the previous edition.)
